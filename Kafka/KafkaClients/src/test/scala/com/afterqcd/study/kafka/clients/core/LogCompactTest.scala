...
/**
  ...
  */
class LogCompactTest extends Integration {
  "Kafka" should "普通Topic保留最新一段时间的所有日志" in {
    ...
    allKeyValueRecords(consumer) should contain theSameElementsInOrderAs Seq(
      KeyValueRecord("a", "1"), KeyValueRecord("b", "2"),
      KeyValueRecord("a", "3"), KeyValueRecord("b", "4")
    )
  ...
  it should "Compact Topic仅为每个Key保留最新的Value" in {
    ...
    allKeyValueRecords(consumer1) should contain theSameElementsInOrderAs Seq(
      KeyValueRecord("a", "1"), KeyValueRecord("b", "2"), KeyValueRecord("c", "C"),
      KeyValueRecord("a", "3"), KeyValueRecord("b", "4"), KeyValueRecord("c", null)
    )
    ...
    allKeyValueRecords(consumer2) should contain theSameElementsInOrderAs Seq(
      KeyValueRecord("a", "3"), KeyValueRecord("b", "4"),
      KeyValueRecord("c", null), KeyValueRecord("d", "D")
    )
